                                                                                    ...
                                                                                    if (headersInput.isNotEmpty) {
                                                                                      try {
                                                                                        ...
                                                                                        for (var i = 0; i < splitHeaders.length; i++) {
                                                                                          ...
                                                                                          headersMap[singleEntries[0]] = singleEntries[1].toString().removeClutter();
                                                                                        }
                                                                                        headers = headersMap;
                                                                                      } catch (e) {
                                                                                        ...
                                                                                        print("error on headers split: $e $headers");
                                                                                      }
                                                                                    } else {
                                                                                      headers = {
