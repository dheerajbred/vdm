...
void main() async {
  ...
  OneSignal.shared.setLogLevel(OSLogLevel.verbose, OSLogLevel.none);
    ...
    //OneSignal.shared.setExternalUserId("dheertemp");
...
_runTheApp() async {
  SharedPreferences preferences = await SharedPreferences.getInstance();
  MyThemeClass initial = MyThemeClass(themename: preferences.getString("themename") ?? MyColorsTheme1.themename,);
...
/*
    ...
    return Provider(
      ...
      child: GetMaterialApp(
        ...
        initialRoute: '/',
        routes: {
          '/': (_) => Downloader(title: "Downloads",),
          //'/download': (_) => DownloadPage(),
          '/download': (_) => DownloadFromShareInPage(arguments),
        },
      ),
    );*/
    ...
    return GetMaterialApp(
      ...
      home: Downloader(title: "Downloads",),
    );
  }
}
/*
